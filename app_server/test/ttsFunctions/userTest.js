 ...
 * Fecha: Mayo 2023
 * Path: app_server\test\ttsFunctions\userTest.js
 * Descripción: Tests para validar el funcionamiento del sistema de usuarios.
 */
const register =
    ...
    describe("Test de login", () => {
      ...
      describe("Test de login con datos incorrectos", () => {
        ...
        test("E-mail vacío", async () => {
          return logTest("", "AAinolosecontrasena!!!!!33", async (response) => {
            expect(response.statusCode).toBe(StatusCodes.BAD_REQUEST);
          });
        });
    ...
    describe("Test de obtener info de un usuario", () => {
      describe("Test de obtener info con id existente", () => {
        test("Test de obtener info con un id existente", async () => {
          return getUserTest(1, async (response) => {
            expect(response.statusCode).toBe(StatusCodes.OK);
          });
        });
      });
    ...
    describe("Test de obtener id de un usuario", () => {
      describe("Test de obtener id con datos correctos", () => {
        test("Test de obtener id con un nickname existente", async () => {
          return getUserIdConNickname("test", async (response) => {
            expect(response.statusCode).toBe(StatusCodes.OK);
          });
        });

        test("Test de obtener id con un email existente", async () => {
          return getUserIdConEmail("traspas@gmail.com", async (response) => {
            expect(response.statusCode).toBe(StatusCodes.OK);
          });
        });
      });
      ...
      describe("Test de obtener info con id no existente", () => {
        test("Test de obtener id con un nickname no existente", async () => {
          return getUserIdConNickname("noExiste", async (response) => {
            expect(response.statusCode).toBe(StatusCodes.BAD_REQUEST);
          });
        });

        test("Test de obtener id con un email no existente", async () => {
          return getUserIdConEmail("noExiste@gmail.com", async (response) => {
            expect(response.statusCode).toBe(StatusCodes.BAD_REQUEST);
          });
        });
